...
# save detection so we can evaluate it later
def save_det(data, result):
    orig_filename = data['img_meta'][0].data[0][0]["filename"]
        
    filename = "./results/" + orig_filename.split("/")[-1].split(".")[-2] + ".txt"
